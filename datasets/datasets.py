...
class DehazingDataset(Dataset):
    def __init__(self, root_dir, crop=False, crop_size=256, multi_scale=False, rotation=False, color_augment=False, transform=None, train = True):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        W = hazy_image.size[0]
        H = hazy_image.size[1] 
        hazy_image = hazy_image.resize((W//2*2, H//2*2))
        clear_image = clear_image.resize((W//2*2, H//2*2))
